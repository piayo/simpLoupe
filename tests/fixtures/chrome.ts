 ...
 *
 * simpLoupe は「任意のページの上に乗るルーペ」なので、姉妹プロジェクトが持つような
 * “特定サイトの DOM を写したフィクスチャ” は要らない。
 ...
 */
export function sendMessage<T>(mock: ChromeMock, command: string, data?: unknown, sender: unknown = { tab: { id: 1, windowId: 9 } }): Promise<T> {
